...
export default {
    ...
    methods: {
        ...
        const canvasRef = `playerChart-${this.selectedPlayer.user_id}`;
        ...
        const colors = this.selectedPlayer.colours;
        ...
        Object.entries(colors).forEach(([color, count]) => {
            if (count > 0) {
                labels.push(this.getColorName(color));
                data.push(count);
                backgroundColors.push(this.getChartColor(color));
            }
        });

        if (data.length > 0) {
            this.playerColorChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [{
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    return `${context.label}: ${context.raw} game${context.raw !== 1 ? 's' : ''}`;
                                }
                            }
                        }
                    }
        ...
        getChartColor(color) {
                ...
                return chartColors[color] || 'rgb(156, 163, 175)';
            },
        ...
        initCharts() {
            ...
            if (this.statistics.faction_distribution) {
                ...
                const factionColorMap={
                    ...
                    "Adepta Sororitas":'U',
                    "Adeptus Custodes":'U',
                    "Adeptus Mechanicus":'U',
                    "Adeptus Titanicus":'U',
                    "Agents of The Imperium":'U',
                    "Astra Militarum":'U',
                    "Grey Knights":'U',
                    "Imperial Knights":'U',
                    "Aeldari":'G',
                    ...
                    "Tau Empire":'G',
                    "Tyranids":'G',
                    "Celestian Insidiants": "U",
                    "Novitiates": "U",
                    "Battleclade": "U",
                    "Hunter Clade": "U",
                    "Elucidian Starstriders": "U",
                    "Exaction Squad": "U",
                    "Imperial Navy Breachers": "U",
                    "Inquisitorial Agents": "U",
                    "Sanctifiers": "U",
                    "DeathKorps": "U",
                    "Kasrkin": "U",
                    "Ratlings": "U",
                    "Spectre Squad": "U",
                    "Tempestus Aquilons": "U",
                    "Brood Brothers": "G",
                    "Wyrmblade": "G",
                    "Hearthkyn Salvagers": "G",
                    "Hernkyn Yaegir": "G",
                    "Canoptek Circle": "G",
                    "Hierotek Circle": "G",
                    "Kommandos": "G",
                    "Wrecka Krew": "G",
                    "Farstalker Kinband": "G",
                    "Pathfinders": "G",
                    "Vespid Stingwings": "G",
                    "XV26 Stealth Battlesuits": "G",
                    "Raveners": "G",
                    "Gellerpox Infected": "R",
                    "Legionaries": "R",
                    "Murderwing": "R",
                    "Nemesis Claw": "R",
                    "Blooded": "R",
